...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-^#b^4$v%r4vq0w$1ljvnhh6fo02kajzjr0-d#)!tx9h32&qlhn')
...
if os.environ.get('DATABASE_URL'):
    ...
    # Fallback to your local PostgreSQL or SQLite
    DATABASES = {
        'default': {
    ...
    if not all([config('DB_NAME', default=None), config('DB_USER', default=None)]):
        DATABASES['default'] = {
